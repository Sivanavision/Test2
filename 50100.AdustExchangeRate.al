report 50100 "Adjust Exchange Rates RCTS"
{
    ApplicationArea = Basic, Suite;
    Caption = 'Adjust Exchange Rates RCTS';
                ...
                begin
                    ...
                    if AdjAmount <> 0 then begin
                        ...
                        if TempEntryNoAmountBuf.Amount <> 0 then begin
                            ...
                            if TempEntryNoAmountBuf.Amount > 0 then//changes realized accounts to unrealized accounts SN220422 "GetrealizedGainsAccount"
                                PostAdjmt(
                                  Currency.GetUnrealizedGainsAccount(), -TempEntryNoAmountBuf.Amount, TempEntryNoAmountBuf.Amount2,
                                  "Currency Code", TempDimSetEntry, PostingDate, '')
                            else//changes realized accounts to unrealized accounts SN220422 "GetrealizedLossedAccount"
                                PostAdjmt(
                                  Currency.GetUnrealizedLossesAccount(), -TempEntryNoAmountBuf.Amount, TempEntryNoAmountBuf.Amount2,
                                  "Currency Code", TempDimSetEntry, PostingDate, '');
                        end;
                    end;
